...
public class SampleTest1 extends BaseTest {
    ...
    @DataProvider(name = "getSampleTestCapability")
    public static Object[] getSampleTestCapability() {
        return LTCapability.getCapabilities("SampleTest1");
    }

    @Test(dataProvider = "getSampleTestCapability")
